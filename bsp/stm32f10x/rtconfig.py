...
# 'FMT0371','ILI932X', 'SSD1289', 'ILIDEMO'
RT_USING_LCD_TYPE = 'ILIDEMO'
...
if PLATFORM == 'gcc':
    ...
    AFLAGS = DEVICE
    LFLAGS = DEVICE + ' --map --info sizes --info totals --info unused --info veneers --list rtthread-stm32.map --scatter stm32_rom.sct'
